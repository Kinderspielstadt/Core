...
const accountDetails =
  ref<AccountsResponse<{ personalData: AccountsDataResponse }>>();
...
<template>
  <AtomModal :id="id" ref="modal" close-button w-auto>
      ...
      <template v-if="accountDetails">
        <div class="stats stats-vertical">
          ...
          <div class="stat">
            ...
            <div class="stat-value">
              {{
                accountDetails.lastCheckIn
                  ? DateService.toTime(new Date(accountDetails.lastCheckIn))
                  : 'N/A'
              }}
            </div>
            <div v-if="accountDetails.lastCheckIn" class="stat-desc">
              {{
          ...
          <template v-if="accountDetails.expand?.personalData">
            <div class="stat">
              ...
              <div class="stat-value">
                {{
                  accountDetails.expand.personalData.vegetarian
                    ? 'Vegetarisch'
                    : 'Fleisch-Esser:in'
                }}
              </div>
            ...
            <div class="stat">
              ...
              <div class="stat-value">
                {{ accountDetails.expand.personalData.intolerances || 'N/A' }}
              </div>
            </div>
            <div class="stat">
              ...
              <div class="stat-value">
                {{
                  accountDetails.expand.personalData.oneweek
                    ? 'Eine Woche'
                    : 'Zwei Wochen'
                }}
              </div>
              ...
              <div class="stat-value">
                {{
                  DateService.toShortString(
                    new Date(accountDetails.expand.personalData.birthday),
                  )
                }}
              </div>
            </div>
            ...
            <div class="stat">
              ...
              <div class="stat-value">
                {{ accountDetails.expand.personalData.street }}
              </div>
              <div class="stat-desc">
                {{ accountDetails.expand.personalData.zipCode }}
                {{ accountDetails.expand.personalData.city }}
              </div>
            </div>
            <div class="stat">
          ...
          <template v-else>
            <div class="stat">
              ...
              <div class="stat-desc">
                Dies ist vermutlich ein technischer Fehler.
              </div>
            </div>
          </template>
        </div>

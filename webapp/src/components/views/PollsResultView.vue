...
onMounted(async () => {
  ...
  subscription.value = await PollsService.subscribeToPollChanges(
    (pollSubscription) => {
      if (results.value) {
        switch (pollSubscription.action) {
          ...
          case 'delete':
            results.value = results.value.filter(
              (result) => result.id !== pollSubscription.record.id,
            );
            break;
        }
      }
    ...
    <div v-if="results" class="stats">
      <div class="stat place-items-center">
        ...
        <div class="stat-value">
          {{ results.filter((poll) => poll.option === 'A').length }}
        </div>
      ...
      <div class="stat place-items-center">
        ...
        <div class="stat-value">
          {{ results.filter((poll) => poll.option === 'B').length }}
        </div>
        <div class="stat-desc">Abstimmungen</div>
      </div>
      <div class="stat place-items-center">
        ...
        <div class="stat-value">
          {{ results.filter((poll) => poll.option === 'C').length }}
        </div>
        <div class="stat-desc">Abstimmungen</div>
      </div>
      <div class="stat place-items-center">
        ...
        <div class="stat-value">
          {{ results.filter((poll) => poll.option === 'D').length }}
        </div>
        <div class="stat-desc">Abstimmungen</div>
      </div>
    </div>
